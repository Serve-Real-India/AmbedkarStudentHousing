...
List<OnboardModel> screens = <OnboardModel>[
    ...
    OnboardModel(
      ...
      text: "Please acknowledge that you identify as being from one of the oppressed caste communities broadly identified as SC, ST, OBC, or are from one of these oppressed caste communities but you or your ancestors have since converted and are part of other religious minorities.",
      desc:
          "Please acknowledge and proceed to the next step",
      bg: Color(0xFF4756DF),
      button: Colors.white,
